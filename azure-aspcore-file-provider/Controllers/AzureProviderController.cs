...
namespace EJ2AzureASPCoreFileProvider.Controllers
{
    ...
    public class AzureProviderController : Controller
    {
        ...
        public AzureProviderController(IHostingEnvironment hostingEnvironment)
        {
            ...
            this.operation.SetBlobContainer("https://filemgrnirmitee.blob.core.windows.net/filemgrnirmitee/", "https://filemgrnirmitee.blob.core.windows.net/filemgrnirmitee/Files");            
            this.operation.RegisterAzure("filemgrnirmitee", "MS+gOPmdDrTmJOWbxQwPhtO4nr9M5vFiTPqe/KAlwAyddyRKMG0IkoiDSm4z0182J2QhZriROk7FrdoggHoc+A==", "filemgrnirmitee");
            //----------
            //For example 
        ...
        public object AzureFileOperations([FromBody] FileManagerDirectoryContent args)
        {
            if (args.Path != "")
            {
                string startPath = "https://filemgrnirmitee.blob.core.windows.net/filemgrnirmitee/";
                string originalPath = ("https://filemgrnirmitee.blob.core.windows.net/filemgrnirmitee/Files").Replace(startPath, "");
                //-----------------
                //For example
